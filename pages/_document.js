		...
		return (
			<Html>
				<Head>
					...
					<meta name='twitter:url' content={manifest.site} />
					<meta name='twitter:title' content={manifest.name} />
					<meta name='twitter:description' content={manifest.description} />
					<meta name='twitter:image' content={`${manifest.site}${manifest.icons[1].src}`} />
					<meta name='twitter:creator' content={manifest.twitter} />
					<meta property='og:type' content='website' />
					<meta property='og:title' content={manifest.name} />
					<meta property='og:description' content={manifest.description} />
					<meta property='og:site_name' content={manifest.name} />
					<meta property='og:url' content={manifest.site} />
					<meta property='og:image' content={`${manifest.site}${manifest.icons[1].src}`} />
