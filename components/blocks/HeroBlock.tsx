			...
			<div className='py-12 md:py-24 bg-gray-100'>
				<div
					...
					<div className='order-2 md:order-1 col-span-3 self-center'>
						<h1 className='text-gray-800 text-3xl md:text-4xl lg:text-5xl font-bold mb-2 md:mb-4 lg:mb-8'>Playground da
							Computação</h1>
						<p className='text-lg xl:text-xl text-gray-600 mb-6 lg:mb-8 xl:mb-10'>Servidor de minecraft do grupo de
							Ciência da Computação do IFG.</p>
						...
						{/*	</button>*/}
						{/*</div>*/}
						<p className='text-gray-500 text-sm'>Versão 1.17 do minecraft.</p>
					</div>
					<div className='hidden md:order-2 col-span-1 xl:col-span-1'>
						<img src='/img/skeleton.png' className='h-80' alt='' />
					</div>
				</div>
			</div>
