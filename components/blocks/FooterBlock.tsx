		...
		<>
			<footer className='bg-white text-gray-600 py-12 xl:pb-24'>
				...
				<div
					...
					{/*<a href='#'*/}
					{/*	 className='inline-block bg-gradient-to-br from-yellow-600 to-yellow-700 hover:from-yellow-500 hover:to-yellow-700 font-semibold rounded-lg py-4 px-5 lg:px-8 text-white md:transform md:-translate-y-2'>Start*/}
					{/*	your free trial</a>*/}
				</div>
				{/*<div*/}
				{/*	className='max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 flex flex-col md:flex-row justify-between items-center space-y-4 mt-8 lg:mt-12'>*/}
