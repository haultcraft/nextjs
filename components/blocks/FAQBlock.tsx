        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 relative z-20">
          ...
          <div className="mb-12 lg:mb-20">
            <ul className="divide-y divide-gray-300text-base md:text-lg">
              <li>
                <button
                  className="py-3 lg:py-4 font-bold focus:outline-none hover:text-yellow-700 w-full flex items-center justify-between">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12  ">
            <a href="#"
               className="bg-white rounded-lg shadow hover:shadow-xl transition-all duration-500 p-6 lg:p-8 border border-yellow-100 flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-6">
              <div
                className="h-16 w-16 lg:h-20 lg:w-20 bg-green-100 rounded-full flex items-center justify-center border border-green-200 shadow-inner">
              ...
              <div className="flex-1">
                ...
                <span className="font-bold text-lg text-yellow-600 flex items-baseline">
              View price comparison
              <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                   xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round"
                                                            strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </span>
              </div>
            </a>
            <a href="#"
